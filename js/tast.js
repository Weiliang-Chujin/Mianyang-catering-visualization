...
var width = 230;
var height = 180;
var svg = d3.select("#tast").append("svg")
				.attr("width",width)
				.attr("height",height);
svg.append("text")
	   .attr("x",5)
...
arcs.append("text")
	...
	.attr("fill","black")
	.text(function(d){
		var percent = Number(d.value)/d3.sum(dataTastsum)*100;
...
//添加一个提示框
		...
		tooltip.html("有"+d.value+"条评论给其"+"<br />"+"消费店铺口味评分为"+i+"，占比"+percent.toFixed(0)+'%')
